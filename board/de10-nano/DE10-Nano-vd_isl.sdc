...
create_clock -period 200MHz -name pclk_si [get_ports GPIO_0[0]]
...
set_false_path -from [get_ports {GPIO_0[32] GPIO_0[34] KEY* ARDUINO_IO[7] ARDUINO_IO[6] ARDUINO_IO[5] ARDUINO_IO[4]}]
